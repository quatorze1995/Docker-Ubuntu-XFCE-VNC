...
# Install packages
RUN apt-get update -y && apt-get install -y --no-install-recommends --no-install-suggests install \
...
RUN apt-get install -y --no-install-recommends --no-install-suggests install \
